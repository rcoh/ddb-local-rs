...
pub mod update_item_input {
    ...
    #[allow(clippy::enum_variant_names)]
        ...
        #[doc(hidden)]
        ReturnItemCollectionMetrics(crate::model::return_item_collection_metrics::ConstraintViolation),
    }
    ...
    impl ::std::convert::From<ConstraintViolation> for ::aws_smithy_legacy_http_server::protocol::aws_json::rejection::RequestRejection {
    ...
    impl ::std::convert::From<Builder> for crate::constrained::MaybeConstrained<crate::input::UpdateItemInput> {
    ...
    impl  Builder  {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub fn attribute_updates(mut self, input: ::std::option::Option<::std::collections::HashMap::<::std::string::String, crate::model::AttributeValueUpdate>>) -> Self {
            self.attribute_updates =
                input.map(|v|
                    crate::constrained::MaybeConstrained::Constrained((v).into())
                )
            ; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_attribute_updates(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::constrained::attribute_updates_constrained::AttributeUpdatesConstrained>>>) -> Self {
            self.attribute_updates = input.map(|v| v.into());
                            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn expected(mut self, input: ::std::option::Option<::std::collections::HashMap::<::std::string::String, crate::model::ExpectedAttributeValue>>) -> Self {
            self.expected =
                input.map(|v|
                    crate::constrained::MaybeConstrained::Constrained((v).into())
                )
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_expected(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::constrained::expected_attribute_map_constrained::ExpectedAttributeMapConstrained>>>) -> Self {
            self.expected = input.map(|v| v.into());
                            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn conditional_operator(mut self, input: ::std::option::Option<crate::model::ConditionalOperator>) -> Self {
            self.conditional_operator =
                input.map(crate::constrained::MaybeConstrained::Constrained)
            ; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_conditional_operator(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::model::ConditionalOperator>>>) -> Self {
            self.conditional_operator = input.map(|v| v.into());
                            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn return_values(mut self, input: ::std::option::Option<crate::model::ReturnValue>) -> Self {
            self.return_values =
                input.map(crate::constrained::MaybeConstrained::Constrained)
            ; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_return_values(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::model::ReturnValue>>>) -> Self {
            self.return_values = input.map(|v| v.into());
                            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn return_consumed_capacity(mut self, input: ::std::option::Option<crate::model::ReturnConsumedCapacity>) -> Self {
            self.return_consumed_capacity =
                input.map(crate::constrained::MaybeConstrained::Constrained)
            ; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_return_consumed_capacity(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::model::ReturnConsumedCapacity>>>) -> Self {
            self.return_consumed_capacity = input.map(|v| v.into());
                            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn return_item_collection_metrics(mut self, input: ::std::option::Option<crate::model::ReturnItemCollectionMetrics>) -> Self {
            self.return_item_collection_metrics =
                input.map(crate::constrained::MaybeConstrained::Constrained)
            ; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_return_item_collection_metrics(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::model::ReturnItemCollectionMetrics>>>) -> Self {
            self.return_item_collection_metrics = input.map(|v| v.into());
                            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn update_expression(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
            self.update_expression =
                input
            ; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_update_expression(mut self, input: Option<impl ::std::convert::Into<::std::string::String>>) -> Self {
        ...
        fn build_enforcing_all_constraints(self) -> Result<crate::input::UpdateItemInput , ConstraintViolation> {
            Ok(
                crate::input::UpdateItemInput {
                    ...
                    attribute_updates: self.attribute_updates
                        ...
                        .map(|res|
                                        res.map(|v| v.into()).map_err(ConstraintViolation::AttributeUpdates)
                                    )
                                    .transpose()?
                    ,
                    expected: self.expected
                        ...
                        .map(|res|
                                        res.map(|v| v.into()).map_err(ConstraintViolation::Expected)
                                    )
                                    .transpose()?
                    ,
                    conditional_operator: self.conditional_operator
                        ...
                        .map(|res|
                                        res.map_err(ConstraintViolation::ConditionalOperator)
                                    )
                                    .transpose()?
                    ,
                    return_values: self.return_values
                        ...
                        .map(|res|
                                        res.map_err(ConstraintViolation::ReturnValues)
                                    )
                                    .transpose()?
                    ,
                    return_consumed_capacity: self.return_consumed_capacity
                        ...
                        .map(|res|
                                        res.map_err(ConstraintViolation::ReturnConsumedCapacity)
                                    )
                                    .transpose()?
                    ,
                    return_item_collection_metrics: self.return_item_collection_metrics
                        ...
                        .map(|res|
                                        res.map_err(ConstraintViolation::ReturnItemCollectionMetrics)
                                    )
                                    .transpose()?
                    ,
...
pub mod create_table_input {
    ...
    impl ::std::convert::From<Builder> for crate::constrained::MaybeConstrained<crate::input::CreateTableInput> {
                    fn from(builder: Builder) -> Self {
                        Self::Unconstrained(builder)
                    }
                }
    ...
    impl  Builder  {
        #[allow(missing_docs)] // documentation missing in model
        pub fn attribute_definitions(mut self, input: ::std::vec::Vec::<crate::model::AttributeDefinition>) -> Self {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_attribute_definitions(mut self, input: impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::constrained::attribute_definitions_constrained::AttributeDefinitionsConstrained>>) -> Self {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub fn local_secondary_indexes(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::model::LocalSecondaryIndex>>) -> Self {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_local_secondary_indexes(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::constrained::local_secondary_index_list_constrained::LocalSecondaryIndexListConstrained>>>) -> Self {
            self.local_secondary_indexes = input.map(|v| v.into());
                            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn global_secondary_indexes(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::model::GlobalSecondaryIndex>>) -> Self {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_global_secondary_indexes(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::constrained::global_secondary_index_list_constrained::GlobalSecondaryIndexListConstrained>>>) -> Self {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_billing_mode(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::model::BillingMode>>>) -> Self {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_stream_specification(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::model::StreamSpecification>>>) -> Self {
            self.stream_specification = input.map(|v| v.into());
                            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn sse_specification(mut self, input: ::std::option::Option<crate::model::SseSpecification>) -> Self {
            self.sse_specification =
                input.map(crate::constrained::MaybeConstrained::Constrained)
            ; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_sse_specification(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::model::SseSpecification>>>) -> Self {
            self.sse_specification = input.map(|v| v.into());
                            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub fn tags(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::model::Tag>>) -> Self {
            self.tags =
                input.map(|v|
                    crate::constrained::MaybeConstrained::Constrained((v).into())
                )
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_tags(mut self, input: Option<impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::constrained::tag_list_constrained::TagListConstrained>>>) -> Self {
        ...
        fn build_enforcing_all_constraints(self) -> Result<crate::input::CreateTableInput , ConstraintViolation> {
            Ok(
                crate::input::CreateTableInput {
                    attribute_definitions: self.attribute_definitions
                        ...
                        .map(|res|
                                        res.map(|v| v.into()).map_err(ConstraintViolation::AttributeDefinitions)
                                    )
                                    .transpose()?
                    ...
                    local_secondary_indexes: self.local_secondary_indexes
                        ...
                        .map(|res|
                                        res.map(|v| v.into()).map_err(ConstraintViolation::LocalSecondaryIndexes)
                                    )
                                    .transpose()?
                    ,
                    global_secondary_indexes: self.global_secondary_indexes
                        ...
                        .map(|res|
                                        res.map(|v| v.into()).map_err(ConstraintViolation::GlobalSecondaryIndexes)
                                    )
                                    .transpose()?
                    ,
                    billing_mode: self.billing_mode
                        ...
                        .map(|res|
                                        res.map_err(ConstraintViolation::BillingMode)
                                    )
                                    .transpose()?
                    ,
                    ...
                    stream_specification: self.stream_specification
                        ...
                        .map(|res|
                                        res.map_err(ConstraintViolation::StreamSpecification)
                                    )
                                    .transpose()?
                    ,
                    sse_specification: self.sse_specification
                        ...
                        .map(|res|
                                        res.map_err(ConstraintViolation::SseSpecification)
                                    )
                                    .transpose()?
                    ,
                    tags: self.tags
                        ...
                        .map(|res|
                                        res.map(|v| v.into()).map_err(ConstraintViolation::Tags)
                                    )
                                    .transpose()?
                    ,
                }
...
pub mod get_item_input {
    ...
    impl  Builder  {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub fn attributes_to_get(mut self, input: ::std::option::Option<::std::vec::Vec::<::std::string::String>>) -> Self {
            self.attributes_to_get =
                input
            ; self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_attributes_to_get(mut self, input: Option<impl ::std::convert::Into<::std::vec::Vec::<::std::string::String>>>) -> Self {
