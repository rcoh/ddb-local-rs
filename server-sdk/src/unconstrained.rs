...
pub(crate) mod expected_attribute_map_unconstrained {
    ...
    #[derive(Debug, Clone)]
    pub(crate) struct ExpectedAttributeMapUnconstrained(
        pub(crate)  std::collections::HashMap<
            ::std::string::String,
            crate::model::expected_attribute_value::Builder,
        >,
    );

    impl From<ExpectedAttributeMapUnconstrained>
        for crate::constrained::MaybeConstrained<
            crate::constrained::expected_attribute_map_constrained::ExpectedAttributeMapConstrained,
        >
    {
    ...
    impl std::convert::TryFrom<ExpectedAttributeMapUnconstrained>
        for crate::constrained::expected_attribute_map_constrained::ExpectedAttributeMapConstrained
    {
        type Error = crate::model::expected_attribute_map::ConstraintViolation;
        fn try_from(
            value: ExpectedAttributeMapUnconstrained,
            ...
            > = value
                ...
                .into_iter()
                .map(
                    |(k, v)| match crate::model::ExpectedAttributeValue::try_from(v) {
                        Ok(v) => Ok((k, v)),
...
pub(crate) mod attribute_updates_unconstrained {
    ...
    #[derive(Debug, Clone)]
    pub(crate) struct AttributeUpdatesUnconstrained(
        pub(crate)  std::collections::HashMap<
            ::std::string::String,
            crate::model::attribute_value_update::Builder,
        >,
    );

    impl From<AttributeUpdatesUnconstrained>
        for crate::constrained::MaybeConstrained<
            crate::constrained::attribute_updates_constrained::AttributeUpdatesConstrained,
        >
    {
    ...
    impl std::convert::TryFrom<AttributeUpdatesUnconstrained>
        for crate::constrained::attribute_updates_constrained::AttributeUpdatesConstrained
    {
        type Error = crate::model::attribute_updates::ConstraintViolation;
        fn try_from(
            value: AttributeUpdatesUnconstrained,
        ) -> std::result::Result<Self, Self::Error> {
            let res: ::std::result::Result<
                ::std::collections::HashMap<
                    ::std::string::String,
            ...
            > = value
                ...
                .into_iter()
                .map(
                    |(k, v)| match crate::model::AttributeValueUpdate::try_from(v) {
                        Ok(v) => Ok((k, v)),
                        Err(inner_constraint_violation) => {
                            Err(Self::Error::Value(k, inner_constraint_violation))
                        }
...
pub(crate) mod key_schema_unconstrained {
    ...
    #[derive(Debug, Clone)]
    pub(crate) struct KeySchemaUnconstrained(
        pub(crate) std::vec::Vec<crate::model::key_schema_element::Builder>,
    );

    impl From<KeySchemaUnconstrained>
        for crate::constrained::MaybeConstrained<
    ...
    impl std::convert::TryFrom<KeySchemaUnconstrained>
        for crate::constrained::key_schema_constrained::KeySchemaConstrained
    {
        ...
        fn try_from(value: KeySchemaUnconstrained) -> std::result::Result<Self, Self::Error> {
            let res: ::std::result::Result<
                ::std::vec::Vec<crate::model::KeySchemaElement>,
                (usize, crate::model::key_schema_element::ConstraintViolation),
            > = value
                .0
                .into_iter()
                .enumerate()
...
pub(crate) mod attribute_definitions_unconstrained {
    ...
    #[derive(Debug, Clone)]
    pub(crate) struct AttributeDefinitionsUnconstrained(
        pub(crate) std::vec::Vec<crate::model::attribute_definition::Builder>,
    );

    impl From<AttributeDefinitionsUnconstrained>
        for crate::constrained::MaybeConstrained<
            crate::constrained::attribute_definitions_constrained::AttributeDefinitionsConstrained,
        >
    {
    ...
    impl std::convert::TryFrom<AttributeDefinitionsUnconstrained>
        for crate::constrained::attribute_definitions_constrained::AttributeDefinitionsConstrained
    {
        type Error = crate::model::attribute_definitions::ConstraintViolation;
        fn try_from(
            value: AttributeDefinitionsUnconstrained,
        ) -> std::result::Result<Self, Self::Error> {
            let res: ::std::result::Result<
                ::std::vec::Vec<crate::model::AttributeDefinition>,
                (
                    usize,
...
pub(crate) mod tag_list_unconstrained {
    ...
    impl From<TagListUnconstrained>
        for crate::constrained::MaybeConstrained<
    ...
    impl std::convert::TryFrom<TagListUnconstrained>
        for crate::constrained::tag_list_constrained::TagListConstrained
    {
...
pub(crate) mod global_secondary_index_list_unconstrained {
    ...
    #[derive(Debug, Clone)]
    pub(crate) struct GlobalSecondaryIndexListUnconstrained(
        pub(crate) std::vec::Vec<crate::model::global_secondary_index::Builder>,
    );
...
pub(crate) mod local_secondary_index_list_unconstrained {
    ...
    #[derive(Debug, Clone)]
    pub(crate) struct LocalSecondaryIndexListUnconstrained(
        pub(crate) std::vec::Vec<crate::model::local_secondary_index::Builder>,
    );
