        ...
        From<<B as ::aws_smithy_http_server::body::HttpBody>::Error>,
{
    Ok({
        ...
        if !bytes.is_empty() {
            ...
            input =
                crate::protocol_serde::shape_create_table::de_create_table(bytes.as_ref(), input)?;
        }
        input.build()?
    })
}
...
#[allow(clippy::unnecessary_wraps)]
pub fn ser_create_table_http_error(
    error: &crate::error::CreateTableError,
) -> std::result::Result<
    ::aws_smithy_http_server::response::Response,
    ::aws_smithy_http_server::protocol::aws_json::rejection::ResponseRejection,
> {
...
pub(crate) fn de_create_table(
    _value: &[u8],
    mut builder: crate::input::create_table_input::Builder,
) -> ::std::result::Result<
    crate::input::create_table_input::Builder,
