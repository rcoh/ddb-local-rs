...
pub(crate) fn de_projection<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> ::std::result::Result<Option<crate::model::projection::Builder>, ::aws_smithy_json::deserialize::error::DeserializeError>
