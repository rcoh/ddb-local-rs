...
#[allow(clippy::unnecessary_wraps)]
pub fn ser_get_item_http_error(error: &crate::error::GetItemError) -> std::result::Result<::aws_smithy_legacy_http_server::response::Response, ::aws_smithy_legacy_http_server::protocol::aws_json::rejection::ResponseRejection> {
    Ok({
        match error {
...
pub(crate) fn de_get_item(_value: &[u8], mut builder: crate::input::get_item_input::Builder) -> ::std::result::Result<crate::input::get_item_input::Builder, ::aws_smithy_json::deserialize::error::DeserializeError> {
        ...
        match tokens.next().transpose()? {
            Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "Key" => {
                        if let Some(v) =
                        crate::protocol_serde::shape_key::de_key(tokens, _value)?
                        {
                    ...
                    "AttributesToGet" => {
                        builder = builder.set_attributes_to_get(
                            crate::protocol_serde::shape_attribute_name_list::de_attribute_name_list(tokens, _value)?
                        );
                    }
                    "ConsistentRead" => {
