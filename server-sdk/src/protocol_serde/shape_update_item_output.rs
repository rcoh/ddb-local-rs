...
pub fn ser_update_item_output_output_output(
    value: &crate::output::UpdateItemOutput,
) -> ::std::result::Result<String, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = ::std::string::String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_update_item_output::ser_update_item_output_output(
        &mut object,
        value,
    )?;
    object.finish();
...
pub fn ser_update_item_output_output(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::output::UpdateItemOutput,
    ...
    if let Some(var_8) = &input.item_collection_metrics {
        ...
        crate::protocol_serde::shape_item_collection_metrics::ser_item_collection_metrics(
            &mut object_9,
            var_8,
        )?;
        object_9.finish();
