...
pub fn ser_get_item_output_output_output(value: &crate::output::GetItemOutput) -> ::std::result::Result<String, ::aws_smithy_types::error::operation::SerializationError> {
