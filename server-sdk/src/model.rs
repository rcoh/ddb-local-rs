...
impl AttributeValue {
    ...
    pub fn as_l(
        &self,
    ) -> ::std::result::Result<&::std::vec::Vec<crate::model::AttributeValue>, &Self> {
...
pub mod return_item_collection_metrics {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#ReturnItemCollectionMetrics' failed to satisfy constraint: Member must satisfy enum value set: [SIZE, NONE]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [SIZE, NONE]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::TryFrom<&str> for ReturnItemCollectionMetrics {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => {
                Err(crate::model::return_item_collection_metrics::ConstraintViolation(s.to_owned()))
            }
        }
    }
}
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::ReturnItemCollectionMetrics>
{
...
pub mod return_consumed_capacity {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#ReturnConsumedCapacity' failed to satisfy constraint: Member must satisfy enum value set: [INDEXES, TOTAL, NONE]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [INDEXES, TOTAL, NONE]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::TryFrom<&str> for ReturnConsumedCapacity {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => Err(crate::model::return_consumed_capacity::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::ReturnConsumedCapacity>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod return_value {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#ReturnValue' failed to satisfy constraint: Member must satisfy enum value set: [NONE, ALL_OLD, UPDATED_OLD, ALL_NEW, UPDATED_NEW]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [NONE, ALL_OLD, UPDATED_OLD, ALL_NEW, UPDATED_NEW]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::TryFrom<&str> for ReturnValue {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => Err(crate::model::return_value::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::ReturnValue>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod conditional_operator {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#ConditionalOperator' failed to satisfy constraint: Member must satisfy enum value set: [AND, OR]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [AND, OR]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::TryFrom<&str> for ConditionalOperator {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => Err(crate::model::conditional_operator::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::ConditionalOperator>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod comparison_operator {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#ComparisonOperator' failed to satisfy constraint: Member must satisfy enum value set: [EQ, NE, IN, LE, LT, GE, GT, BETWEEN, NOT_NULL, NULL, CONTAINS, NOT_CONTAINS, BEGINS_WITH]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [EQ, NE, IN, LE, LT, GE, GT, BETWEEN, NOT_NULL, NULL, CONTAINS, NOT_CONTAINS, BEGINS_WITH]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::TryFrom<&str> for ComparisonOperator {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => Err(crate::model::comparison_operator::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::ComparisonOperator>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod attribute_action {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#AttributeAction' failed to satisfy constraint: Member must satisfy enum value set: [ADD, PUT, DELETE]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [ADD, PUT, DELETE]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::TryFrom<&str> for AttributeAction {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => Err(crate::model::attribute_action::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::AttributeAction>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod sse_type {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#SSEType' failed to satisfy constraint: Member must satisfy enum value set: [AES256, KMS]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [AES256, KMS]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::SSEType>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod sse_status {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#SSEStatus' failed to satisfy constraint: Member must satisfy enum value set: [ENABLING, ENABLED, DISABLING, DISABLED, UPDATING]"#
            )
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::SSEStatus>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod replica_status {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#ReplicaStatus' failed to satisfy constraint: Member must satisfy enum value set: [CREATING, CREATION_FAILED, UPDATING, DELETING, ACTIVE, REGION_DISABLED, INACCESSIBLE_ENCRYPTION_CREDENTIALS]"#
            )
        }
    }
    ...
    fn try_from(
        ...
        match s {
            ...
            "INACCESSIBLE_ENCRYPTION_CREDENTIALS" => {
                Ok(ReplicaStatus::InaccessibleEncryptionCredentials)
            }
            "REGION_DISABLED" => Ok(ReplicaStatus::RegionDisabled),
            "UPDATING" => Ok(ReplicaStatus::Updating),
            _ => Err(crate::model::replica_status::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::ReplicaStatus>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod stream_view_type {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#StreamViewType' failed to satisfy constraint: Member must satisfy enum value set: [NEW_IMAGE, OLD_IMAGE, NEW_AND_OLD_IMAGES, KEYS_ONLY]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [NEW_IMAGE, OLD_IMAGE, NEW_AND_OLD_IMAGES, KEYS_ONLY]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::TryFrom<&str> for StreamViewType {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => Err(crate::model::stream_view_type::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::StreamViewType>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod index_status {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#IndexStatus' failed to satisfy constraint: Member must satisfy enum value set: [CREATING, UPDATING, DELETING, ACTIVE]"#
            )
        }
    }
...
impl ::std::convert::TryFrom<&str> for IndexStatus {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => Err(crate::model::index_status::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::IndexStatus>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod projection_type {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#ProjectionType' failed to satisfy constraint: Member must satisfy enum value set: [ALL, KEYS_ONLY, INCLUDE]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [ALL, KEYS_ONLY, INCLUDE]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::TryFrom<&str> for ProjectionType {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => Err(crate::model::projection_type::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::ProjectionType>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod key_type {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#KeyType' failed to satisfy constraint: Member must satisfy enum value set: [HASH, RANGE]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [HASH, RANGE]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::KeyType>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod billing_mode {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#BillingMode' failed to satisfy constraint: Member must satisfy enum value set: [PROVISIONED, PAY_PER_REQUEST]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [PROVISIONED, PAY_PER_REQUEST]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::TryFrom<&str> for BillingMode {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => Err(crate::model::billing_mode::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::BillingMode>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod table_status {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#TableStatus' failed to satisfy constraint: Member must satisfy enum value set: [CREATING, UPDATING, DELETING, ACTIVE, INACCESSIBLE_ENCRYPTION_CREDENTIALS, ARCHIVING, ARCHIVED]"#
            )
        }
    }
...
impl ::std::convert::TryFrom<&str> for TableStatus {
    ...
    fn try_from(
        ...
        match s {
            ...
            "INACCESSIBLE_ENCRYPTION_CREDENTIALS" => {
                Ok(TableStatus::InaccessibleEncryptionCredentials)
            }
            "UPDATING" => Ok(TableStatus::Updating),
            _ => Err(crate::model::table_status::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::TableStatus>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod scalar_attribute_type {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(
                f,
                r#"Value provided for 'com.amazonaws.dynamodb#ScalarAttributeType' failed to satisfy constraint: Member must satisfy enum value set: [S, N, B]"#
            )
        }
    }
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            crate::model::ValidationExceptionField {
                message: format!(
                    r#"Value at '{}' failed to satisfy constraint: Member must satisfy enum value set: [S, N, B]"#,
                    &path
                ),
                path,
            }
...
impl ::std::convert::TryFrom<&str> for ScalarAttributeType {
    ...
    fn try_from(
        ...
        match s {
            ...
            _ => Err(crate::model::scalar_attribute_type::ConstraintViolation(
                s.to_owned(),
            )),
        }
    }
...
impl ::std::convert::From<::std::string::String>
    for crate::constrained::MaybeConstrained<crate::model::ScalarAttributeType>
{
    fn from(value: ::std::string::String) -> Self {
        Self::Unconstrained(value)
    }
...
pub mod expected_attribute_map {
    ...
    pub enum ConstraintViolation {
        ...
        Value(
            ::std::string::String,
            crate::model::expected_attribute_value::ConstraintViolation,
        ),
    }
...
pub mod expected_attribute_value {
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            match self {
                ConstraintViolation::ComparisonOperator(inner) => {
                    inner.as_validation_exception_field(path + "/ComparisonOperator")
                }
            }
        }
    }
    impl ::std::convert::From<Builder>
        for crate::constrained::MaybeConstrained<crate::model::ExpectedAttributeValue>
    {
        fn from(builder: Builder) -> Self {
    ...
    pub struct Builder {
        ...
        pub(crate) comparison_operator: ::std::option::Option<
            crate::constrained::MaybeConstrained<crate::model::ComparisonOperator>,
        >,
    ...
    impl Builder {
        ...
        pub(crate) fn set_value(
            mut self,
            input: Option<impl ::std::convert::Into<crate::model::AttributeValue>>,
        ) -> Self {
        ...
        pub fn comparison_operator(
            ...
            self.comparison_operator = input.map(crate::constrained::MaybeConstrained::Constrained);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_comparison_operator(
            mut self,
            input: Option<
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_attribute_value_list(
            mut self,
            input: Option<impl ::std::convert::Into<::std::vec::Vec<crate::model::AttributeValue>>>,
        ) -> Self {
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::ExpectedAttributeValue, ConstraintViolation> {
            Ok(crate::model::ExpectedAttributeValue {
                value: self.value,
                exists: self.exists,
                comparison_operator: self
                    .comparison_operator
                    .map(|v| match v {
                        crate::constrained::MaybeConstrained::Constrained(x) => Ok(x),
                        crate::constrained::MaybeConstrained::Unconstrained(x) => x.try_into(),
                    })
                    .map(|res| res.map_err(ConstraintViolation::ComparisonOperator))
                    .transpose()?,
...
pub mod attribute_updates {
    ...
    pub enum ConstraintViolation {
        ...
        Value(
            ::std::string::String,
            crate::model::attribute_value_update::ConstraintViolation,
        ),
    }
...
pub mod attribute_value_update {
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            match self {
                ConstraintViolation::Action(inner) => {
                    inner.as_validation_exception_field(path + "/Action")
                }
            }
        }
    }
    impl ::std::convert::From<Builder>
        for crate::constrained::MaybeConstrained<crate::model::AttributeValueUpdate>
    {
        fn from(builder: Builder) -> Self {
            Self::Unconstrained(builder)
        }
    ...
    pub struct Builder {
        ...
        pub(crate) action: ::std::option::Option<
            crate::constrained::MaybeConstrained<crate::model::AttributeAction>,
        >,
    }
    impl Builder {
        #[allow(missing_docs)] // documentation missing in model
        ...
        pub fn action(
            ...
            self.action = input.map(crate::constrained::MaybeConstrained::Constrained);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::AttributeValueUpdate, ConstraintViolation> {
            Ok(crate::model::AttributeValueUpdate {
                value: self.value,
                action: self
                    .action
                    .map(|v| match v {
                    ...
                    .map(|res| res.map_err(ConstraintViolation::Action))
                    .transpose()?,
            })
        }
    }
...
pub mod table_description {
    ...
    pub struct Builder {
        ...
        pub(crate) key_schema:
            ::std::option::Option<::std::vec::Vec<crate::model::KeySchemaElement>>,
    ...
    impl Builder {
        ...
        pub fn local_secondary_indexes(
            mut self,
            input: ::std::option::Option<
                ::std::vec::Vec<crate::model::LocalSecondaryIndexDescription>,
            >,
        ) -> Self {
            self.local_secondary_indexes = input;
            self
...
pub mod restore_summary {
    ...
    impl Builder {
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::RestoreSummary, ConstraintViolation> {
            Ok(crate::model::RestoreSummary {
                source_backup_arn: self.source_backup_arn,
                source_table_arn: self.source_table_arn,
                restore_date_time: self
                    .restore_date_time
                    .ok_or(ConstraintViolation::MissingRestoreDateTime)?,
                restore_in_progress: self
                    .restore_in_progress
...
pub mod replica_description {
    ...
    pub struct Builder {
        ...
        pub(crate) global_secondary_indexes: ::std::option::Option<
            ::std::vec::Vec<crate::model::ReplicaGlobalSecondaryIndexDescription>,
        >,
        pub(crate) replica_inaccessible_date_time:
            ::std::option::Option<::aws_smithy_types::DateTime>,
    }
    impl Builder {
        #[allow(missing_docs)] // documentation missing in model
...
pub mod stream_specification {
    ...
    impl ::std::convert::From<Builder>
        for crate::constrained::MaybeConstrained<crate::model::StreamSpecification>
    {
        fn from(builder: Builder) -> Self {
            Self::Unconstrained(builder)
        }
    ...
    pub struct Builder {
        ...
        pub(crate) stream_view_type: ::std::option::Option<
            crate::constrained::MaybeConstrained<crate::model::StreamViewType>,
        >,
    }
    impl Builder {
        #[allow(missing_docs)] // documentation missing in model
        ...
        pub fn stream_view_type(
            ...
            self.stream_view_type = input.map(crate::constrained::MaybeConstrained::Constrained);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_stream_view_type(
            mut self,
            input: Option<
                impl ::std::convert::Into<
                    crate::constrained::MaybeConstrained<crate::model::StreamViewType>,
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::StreamSpecification, ConstraintViolation> {
            Ok(crate::model::StreamSpecification {
                stream_enabled: self
                    .stream_enabled
                    .ok_or(ConstraintViolation::MissingStreamEnabled)?,
                stream_view_type: self
                    .stream_view_type
                    .map(|v| match v {
                        crate::constrained::MaybeConstrained::Constrained(x) => Ok(x),
                        crate::constrained::MaybeConstrained::Unconstrained(x) => x.try_into(),
                    })
                    .map(|res| res.map_err(ConstraintViolation::StreamViewType))
                    .transpose()?,
            })
        }
    }
...
pub mod provisioned_throughput_description {
    ...
    impl Builder {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub fn last_decrease_date_time(
            mut self,
            input: ::std::option::Option<::aws_smithy_types::DateTime>,
        ) -> Self {
...
pub mod projection {
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            match self {
                ConstraintViolation::ProjectionType(inner) => {
                    inner.as_validation_exception_field(path + "/ProjectionType")
                }
            }
        }
    }
    impl ::std::convert::From<Builder>
        for crate::constrained::MaybeConstrained<crate::model::Projection>
    {
        fn from(builder: Builder) -> Self {
            Self::Unconstrained(builder)
        }
    ...
    #[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
    pub struct Builder {
        pub(crate) projection_type: ::std::option::Option<
            crate::constrained::MaybeConstrained<crate::model::ProjectionType>,
        >,
        pub(crate) non_key_attributes:
    ...
    impl Builder {
        ...
        pub fn projection_type(
            ...
            self.projection_type = input.map(crate::constrained::MaybeConstrained::Constrained);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_projection_type(
            mut self,
            input: Option<
                impl ::std::convert::Into<
                    crate::constrained::MaybeConstrained<crate::model::ProjectionType>,
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_non_key_attributes(
            mut self,
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::Projection, ConstraintViolation> {
            Ok(crate::model::Projection {
                projection_type: self
                    ...
                    .map(|res| res.map_err(ConstraintViolation::ProjectionType))
                    .transpose()?,
...
pub mod key_schema_element {
    ...
    impl ::std::convert::From<Builder>
        for crate::constrained::MaybeConstrained<crate::model::KeySchemaElement>
    {
        fn from(builder: Builder) -> Self {
            Self::Unconstrained(builder)
        }
    ...
    pub struct Builder {
        ...
        pub(crate) key_type:
            ::std::option::Option<crate::constrained::MaybeConstrained<crate::model::KeyType>>,
    }
    impl Builder {
        #[allow(missing_docs)] // documentation missing in model
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_attribute_name(
            mut self,
        ...
        pub fn key_type(mut self, input: crate::model::KeyType) -> Self {
            self.key_type = Some(crate::constrained::MaybeConstrained::Constrained(input));
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_key_type(
            mut self,
            input: impl ::std::convert::Into<
                crate::constrained::MaybeConstrained<crate::model::KeyType>,
            >,
        ) -> Self {
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::KeySchemaElement, ConstraintViolation> {
            Ok(crate::model::KeySchemaElement {
                attribute_name: self
                    .attribute_name
                ...
                key_type: self
                    ...
                    .map(|res| res.map_err(ConstraintViolation::KeyType))
                    .transpose()?
...
pub mod attribute_definitions {
    ...
    pub enum ConstraintViolation {
        ...
        Member(
            usize,
            crate::model::attribute_definition::ConstraintViolation,
        ),
    }
...
pub mod attribute_definition {
    ...
    impl ::std::convert::From<Builder>
        for crate::constrained::MaybeConstrained<crate::model::AttributeDefinition>
    {
        fn from(builder: Builder) -> Self {
            Self::Unconstrained(builder)
        }
    ...
    pub struct Builder {
        pub(crate) attribute_name: ::std::option::Option<::std::string::String>,
        pub(crate) attribute_type: ::std::option::Option<
            crate::constrained::MaybeConstrained<crate::model::ScalarAttributeType>,
        >,
    }
    impl Builder {
        #[allow(missing_docs)] // documentation missing in model
        ...
        pub fn attribute_type(mut self, input: crate::model::ScalarAttributeType) -> Self {
            self.attribute_type = Some(crate::constrained::MaybeConstrained::Constrained(input));
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_attribute_type(
            mut self,
            input: impl ::std::convert::Into<
                crate::constrained::MaybeConstrained<crate::model::ScalarAttributeType>,
            >,
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::AttributeDefinition, ConstraintViolation> {
            Ok(crate::model::AttributeDefinition {
                attribute_name: self
                    .attribute_name
                    .ok_or(ConstraintViolation::MissingAttributeName)?,
                attribute_type: self
                    ...
                    .map(|res| res.map_err(ConstraintViolation::AttributeType))
                    .transpose()?
...
pub mod tag {
    ...
    impl ::std::fmt::Display for ConstraintViolation {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            match self {
                ConstraintViolation::MissingKey => write!(
                    f,
                    "`key` was not provided but it is required when building `Tag`"
                ),
                ConstraintViolation::MissingValue => write!(
                    f,
                    "`value` was not provided but it is required when building `Tag`"
                ),
            }
        ...
        pub(crate) fn as_validation_exception_field(
            ...
            match self {
                ConstraintViolation::MissingKey => crate::model::ValidationExceptionField {
                    message: format!(
                        "Value at '{}/Key' failed to satisfy constraint: Member must not be null",
                        path
                    ),
                    path: path + "/Key",
                },
                ConstraintViolation::MissingValue => crate::model::ValidationExceptionField {
                    message: format!(
                        "Value at '{}/Value' failed to satisfy constraint: Member must not be null",
                        path
                    ),
                    path: path + "/Value",
                },
...
pub mod sse_specification {
    ...
    impl ConstraintViolation {
        pub(crate) fn as_validation_exception_field(
            ...
            match self {
                ConstraintViolation::SseType(inner) => {
                    inner.as_validation_exception_field(path + "/SSEType")
                }
            }
        }
    }
    impl ::std::convert::From<Builder>
        for crate::constrained::MaybeConstrained<crate::model::SseSpecification>
    {
        fn from(builder: Builder) -> Self {
            Self::Unconstrained(builder)
        }
    ...
    pub struct Builder {
        ...
        pub(crate) sse_type:
            ::std::option::Option<crate::constrained::MaybeConstrained<crate::model::SSEType>>,
        pub(crate) kms_master_key_id: ::std::option::Option<::std::string::String>,
    }
    impl Builder {
        #[allow(missing_docs)] // documentation missing in model
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub fn sse_type(mut self, input: ::std::option::Option<crate::model::SSEType>) -> Self {
            self.sse_type = input.map(crate::constrained::MaybeConstrained::Constrained);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_sse_type(
            mut self,
            input: Option<
                impl ::std::convert::Into<crate::constrained::MaybeConstrained<crate::model::SSEType>>,
            >,
        ) -> Self {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_kms_master_key_id(
            mut self,
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::SseSpecification, ConstraintViolation> {
            Ok(crate::model::SseSpecification {
                ...
                sse_type: self
                    ...
                    .map(|res| res.map_err(ConstraintViolation::SseType))
                    .transpose()?,
                kms_master_key_id: self.kms_master_key_id,
            })
        }
...
pub mod provisioned_throughput {
    ...
    impl ::std::convert::From<Builder>
        for crate::constrained::MaybeConstrained<crate::model::ProvisionedThroughput>
    {
        fn from(builder: Builder) -> Self {
            Self::Unconstrained(builder)
        }
    ...
    impl Builder {
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_read_capacity_units(
            mut self,
        ...
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_write_capacity_units(
            mut self,
            input: impl ::std::convert::Into<i64>,
        ) -> Self {
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::ProvisionedThroughput, ConstraintViolation> {
            Ok(crate::model::ProvisionedThroughput {
                read_capacity_units: self
                    .read_capacity_units
                    .ok_or(ConstraintViolation::MissingReadCapacityUnits)?,
                write_capacity_units: self
...
pub mod global_secondary_index_list {
    ...
    pub enum ConstraintViolation {
        ...
        Member(
            usize,
            crate::model::global_secondary_index::ConstraintViolation,
        ),
    }
...
pub mod global_secondary_index {
    ...
    impl ::std::convert::From<Builder>
        for crate::constrained::MaybeConstrained<crate::model::GlobalSecondaryIndex>
    {
        fn from(builder: Builder) -> Self {
            Self::Unconstrained(builder)
        }
    ...
    pub struct Builder {
        pub(crate) index_name: ::std::option::Option<::std::string::String>,
        pub(crate) key_schema: ::std::option::Option<
            crate::constrained::MaybeConstrained<
                crate::constrained::key_schema_constrained::KeySchemaConstrained,
            >,
        >,
        pub(crate) projection:
            ::std::option::Option<crate::constrained::MaybeConstrained<crate::model::Projection>>,
        pub(crate) provisioned_throughput: ::std::option::Option<
    ...
    impl Builder {
        ...
        pub fn index_name(mut self, input: ::std::string::String) -> Self {
            self.index_name = Some(input);
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_index_name(
            mut self,
            input: impl ::std::convert::Into<::std::string::String>,
        ) -> Self {
        ...
        pub fn projection(mut self, input: crate::model::Projection) -> Self {
            self.projection = Some(crate::constrained::MaybeConstrained::Constrained(input));
            self
        }
        #[allow(missing_docs)] // documentation missing in model
        pub(crate) fn set_projection(
            mut self,
            input: impl ::std::convert::Into<
                crate::constrained::MaybeConstrained<crate::model::Projection>,
            >,
        ) -> Self {
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::GlobalSecondaryIndex, ConstraintViolation> {
            Ok(crate::model::GlobalSecondaryIndex {
                index_name: self
                    .index_name
                ...
                projection: self
                    ...
                    .map(|res| res.map_err(ConstraintViolation::Projection))
                    .transpose()?
...
pub mod local_secondary_index_list {
    ...
    pub enum ConstraintViolation {
        ...
        Member(
            usize,
            crate::model::local_secondary_index::ConstraintViolation,
        ),
    }
...
pub mod local_secondary_index {
    ...
    impl ::std::convert::From<Builder>
        for crate::constrained::MaybeConstrained<crate::model::LocalSecondaryIndex>
    {
        fn from(builder: Builder) -> Self {
            Self::Unconstrained(builder)
        }
    ...
    impl Builder {
        ...
        fn build_enforcing_all_constraints(
            self,
        ) -> Result<crate::model::LocalSecondaryIndex, ConstraintViolation> {
            Ok(crate::model::LocalSecondaryIndex {
                index_name: self
                    .index_name
                    .ok_or(ConstraintViolation::MissingIndexName)?,
                key_schema: self
