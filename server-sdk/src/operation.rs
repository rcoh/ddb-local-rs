...
::pin_project_lite::pin_project! {
    ...
    pub struct UpdateItemInputFuture {
        inner: std::pin::Pin<Box<dyn std::future::Future<Output = Result<crate::input::UpdateItemInput, ::aws_smithy_http_server::protocol::aws_json::runtime_error::RuntimeError>> + Send>>
    }
}
...
impl<B>
    ::aws_smithy_http_server::request::FromRequest<
        ...
        B,
    > for crate::input::UpdateItemInput
where
        ...
        From<<B as ::aws_smithy_http_server::body::HttpBody>::Error>,
{
    ...
    fn from_request(request: ::http_1x::Request<B>) -> Self::Future {
        let fut = async move {
            ...
            crate::protocol_serde::shape_update_item::de_update_item_http_request(request).await
        };
...
impl
    ::aws_smithy_http_server::response::IntoResponse<
        ::aws_smithy_http_server::protocol::aws_json_10::AwsJson1_0,
    > for crate::output::UpdateItemOutput
{
...
impl<B>
    ::aws_smithy_http_server::request::FromRequest<
        ::aws_smithy_http_server::protocol::aws_json_10::AwsJson1_0,
        B,
    > for crate::input::CreateTableInput
where
    B: ::aws_smithy_http_server::body::HttpBody + Send,
    B: 'static,
        ...
        From<<B as ::aws_smithy_http_server::body::HttpBody>::Error>,
{
    ...
    fn from_request(request: ::http_1x::Request<B>) -> Self::Future {
        let fut = async move {
            ...
            crate::protocol_serde::shape_create_table::de_create_table_http_request(request).await
        };
        use ::futures_util::future::TryFutureExt;
        let fut = fut.map_err(
            |e: ::aws_smithy_http_server::protocol::aws_json::rejection::RequestRejection| {
...
impl
    ::aws_smithy_http_server::response::IntoResponse<
        ::aws_smithy_http_server::protocol::aws_json_10::AwsJson1_0,
    > for crate::output::CreateTableOutput
{
    fn into_response(self) -> ::aws_smithy_http_server::response::Response {
        ...
        From<<B as ::aws_smithy_http_server::body::HttpBody>::Error>,
{
    ...
    fn from_request(request: ::http_1x::Request<B>) -> Self::Future {
        let fut = async move {
            ...
            crate::protocol_serde::shape_put_item::de_put_item_http_request(request).await
        };
        use ::futures_util::future::TryFutureExt;
        let fut = fut.map_err(
            |e: ::aws_smithy_http_server::protocol::aws_json::rejection::RequestRejection| {
...
impl
    ::aws_smithy_http_server::response::IntoResponse<
        ::aws_smithy_http_server::protocol::aws_json_10::AwsJson1_0,
    > for crate::output::PutItemOutput
{
    fn into_response(self) -> ::aws_smithy_http_server::response::Response {
        ...
        From<<B as ::aws_smithy_http_server::body::HttpBody>::Error>,
{
    ...
    fn from_request(request: ::http_1x::Request<B>) -> Self::Future {
        let fut = async move {
            ...
            crate::protocol_serde::shape_get_item::de_get_item_http_request(request).await
        };
        use ::futures_util::future::TryFutureExt;
        let fut = fut.map_err(
            |e: ::aws_smithy_http_server::protocol::aws_json::rejection::RequestRejection| {
...
impl
    ::aws_smithy_http_server::response::IntoResponse<
        ::aws_smithy_http_server::protocol::aws_json_10::AwsJson1_0,
    > for crate::output::GetItemOutput
{
    fn into_response(self) -> ::aws_smithy_http_server::response::Response {
