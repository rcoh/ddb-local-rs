...
pub struct DynamoDb20120810Builder<Body, L, HttpPl, ModelPl> {
    create_table: Option<::aws_smithy_http_server::routing::Route<Body>>,
    get_item: Option<::aws_smithy_http_server::routing::Route<Body>>,
    put_item: Option<::aws_smithy_http_server::routing::Route<Body>>,
    update_item: Option<::aws_smithy_http_server::routing::Route<Body>>,
    layer: L,
    http_plugin: HttpPl,
...
impl<Body, L, HttpPl, ModelPl> DynamoDb20120810Builder<Body, L, HttpPl, ModelPl> {
    ...
    ///
                    ...
                    where
                        HandlerType: ::aws_smithy_http_server::operation::Handler<crate::operation_shape::UpdateItem, HandlerExtractors>,

                        ModelPl: ::aws_smithy_http_server::plugin::Plugin<
                            DynamoDb20120810<L>,
                            crate::operation_shape::UpdateItem,
                            ::aws_smithy_http_server::operation::IntoService<crate::operation_shape::UpdateItem, HandlerType>
                        >,
                        ::aws_smithy_http_server::operation::UpgradePlugin::<UpgradeExtractors>: ::aws_smithy_http_server::plugin::Plugin<
                            DynamoDb20120810<L>,
                            crate::operation_shape::UpdateItem,
    ...
    ///
                    ...
                    where
                        S: ::aws_smithy_http_server::operation::OperationService<crate::operation_shape::UpdateItem, ServiceExtractors>,

                        ModelPl: ::aws_smithy_http_server::plugin::Plugin<
                            DynamoDb20120810<L>,
                            crate::operation_shape::UpdateItem,
                            ::aws_smithy_http_server::operation::Normalize<crate::operation_shape::UpdateItem, S>
                        >,
                        ::aws_smithy_http_server::operation::UpgradePlugin::<UpgradeExtractors>: ::aws_smithy_http_server::plugin::Plugin<
                            DynamoDb20120810<L>,
                            crate::operation_shape::UpdateItem,
    ...
    where
        ...
        S::Future: Send + 'static,
    {
        self.update_item = Some(::aws_smithy_http_server::routing::Route::new(svc));
        self
    }
}
        ...
        let router = {
            ...
            if self.create_table.is_none() {
                missing_operation_names
                    .insert(crate::operation_shape::CreateTable::ID, ".create_table()");
            }
            ...
            if self.update_item.is_none() {
                missing_operation_names
                    .insert(crate::operation_shape::UpdateItem::ID, ".update_item()");
            }
            ...
            ::aws_smithy_http_server::protocol::aws_json::router::AwsJsonRouter::from_iter([
                (
                    ...
                    self.create_table.expect(unexpected_error_msg),
                ),
                (
                    request_specs::get_item(),
                    self.get_item.expect(unexpected_error_msg),
                ),
                (
                    request_specs::put_item(),
                    self.put_item.expect(unexpected_error_msg),
                ),
                (
                    request_specs::update_item(),
                    self.update_item.expect(unexpected_error_msg),
                ),
            ])
        };
...
impl Operation {
    ...
    pub fn shape_id(&self) -> ::aws_smithy_http_server::shape_id::ShapeId {
        match self {
            Operation::CreateTable => ::aws_smithy_http_server::shape_id::ShapeId::new(
                "com.amazonaws.dynamodb#CreateTable",
                "com.amazonaws.dynamodb",
                "CreateTable",
            ),
            Operation::GetItem => ::aws_smithy_http_server::shape_id::ShapeId::new(
                "com.amazonaws.dynamodb#GetItem",
                "com.amazonaws.dynamodb",
                "GetItem",
            ),
            Operation::PutItem => ::aws_smithy_http_server::shape_id::ShapeId::new(
                "com.amazonaws.dynamodb#PutItem",
                "com.amazonaws.dynamodb",
                "PutItem",
            ),
            Operation::UpdateItem => ::aws_smithy_http_server::shape_id::ShapeId::new(
...
impl<L> ::aws_smithy_http_server::service::ContainsOperation<crate::operation_shape::UpdateItem>
    for DynamoDb20120810<L>
{
...
impl<L, H, M> DynamoDb20120810ConfigBuilder<L, H, M> {
    ...
    pub fn layer<NewLayer>(
        self,
        layer: NewLayer,
    ) -> DynamoDb20120810ConfigBuilder<::tower::layer::util::Stack<NewLayer, L>, H, M> {
        DynamoDb20120810ConfigBuilder {
